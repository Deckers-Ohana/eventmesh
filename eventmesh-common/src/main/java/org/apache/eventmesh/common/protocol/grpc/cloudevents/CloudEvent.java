...
private static final long serialVersionUID = 0L;
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(CloudEventAttributeValue result) {
        int from_bitField0_ = bitField0_;
      }

      private void buildPartialOneofs(CloudEventAttributeValue result) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 58: {
                input.readMessage(
                    getCeTimestampFieldBuilder().getBuilder(),
                    extensionRegistry);
                attrCase_ = 7;
                break;
              } // case 58
  ...
  @Override
  public /* nullable */
CloudEventAttributeValue getAttributesOrDefault(
      String key,
      /* nullable */
CloudEventAttributeValue defaultValue) {
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(CloudEvent result) {
      int from_bitField0_ = bitField0_;
    ...
    private void buildPartialOneofs(CloudEvent result) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 66: {
              input.readMessage(
                  getProtoDataFieldBuilder().getBuilder(),
                  extensionRegistry);
              dataCase_ = 8;
              break;
            } // case 66
    ...
    private static final class AttributesConverter implements com.google.protobuf.MapFieldBuilder.Converter<String, CloudEventAttributeValueOrBuilder, CloudEventAttributeValue> {
      @Override
      public CloudEventAttributeValue build(CloudEventAttributeValueOrBuilder val) {
        if (val instanceof CloudEventAttributeValue) { return (CloudEventAttributeValue) val; }
        return ((CloudEventAttributeValue.Builder) val).build();
      }

      @Override
      public com.google.protobuf.MapEntry<String, CloudEventAttributeValue> defaultEntry() {
    ...
    private com.google.protobuf.MapFieldBuilder<
        String, CloudEventAttributeValueOrBuilder, CloudEventAttributeValue, CloudEventAttributeValue.Builder> attributes_;
    private com.google.protobuf.MapFieldBuilder<String, CloudEventAttributeValueOrBuilder, CloudEventAttributeValue, CloudEventAttributeValue.Builder>
        internalGetAttributes() {
      if (attributes_ == null) {
...
CloudEventAttributeValue defaultValue) {
      if (key == null) { throw new NullPointerException("map key"); }
      java.util.Map<String, CloudEventAttributeValueOrBuilder> map = internalGetMutableAttributes().ensureBuilderMap();
    ...
    public Builder putAttributes(
        ...
        org.apache.eventmesh.common.protocol.grpc.cloudevents.CloudEvent.CloudEventAttributeValue value) {
      if (key == null) { throw new NullPointerException("map key"); }
    ...
    public Builder putAllAttributes(
        java.util.Map<java.lang.String, org.apache.eventmesh.common.protocol.grpc.cloudevents.CloudEvent.CloudEventAttributeValue> values) {
      for (java.util.Map.Entry<java.lang.String, org.apache.eventmesh.common.protocol.grpc.cloudevents.CloudEvent.CloudEventAttributeValue> e : values.entrySet()) {
     ...
     * <code>map&lt;string, .org.apache.eventmesh.cloudevents.v1.CloudEvent.CloudEventAttributeValue&gt; attributes = 5;</code>
     */
    public org.apache.eventmesh.common.protocol.grpc.cloudevents.CloudEvent.CloudEventAttributeValue.Builder putAttributesBuilderIfAbsent(
        java.lang.String key) {
      java.util.Map<java.lang.String, org.apache.eventmesh.common.protocol.grpc.cloudevents.CloudEvent.CloudEventAttributeValueOrBuilder> builderMap = internalGetMutableAttributes().ensureBuilderMap();
      org.apache.eventmesh.common.protocol.grpc.cloudevents.CloudEvent.CloudEventAttributeValueOrBuilder entry = builderMap.get(key);
      if (entry == null) {
        entry = org.apache.eventmesh.common.protocol.grpc.cloudevents.CloudEvent.CloudEventAttributeValue.newBuilder();
        builderMap.put(key, entry);
      }
      if (entry instanceof org.apache.eventmesh.common.protocol.grpc.cloudevents.CloudEvent.CloudEventAttributeValue) {
        entry = ((org.apache.eventmesh.common.protocol.grpc.cloudevents.CloudEvent.CloudEventAttributeValue) entry).toBuilder();
        builderMap.put(key, entry);
      }
      return (org.apache.eventmesh.common.protocol.grpc.cloudevents.CloudEvent.CloudEventAttributeValue.Builder) entry;
    }
  ...
  private static final org.apache.eventmesh.common.protocol.grpc.cloudevents.CloudEvent DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new org.apache.eventmesh.common.protocol.grpc.cloudevents.CloudEvent();
  }

  public static org.apache.eventmesh.common.protocol.grpc.cloudevents.CloudEvent getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  ...
  @java.lang.Override
  public org.apache.eventmesh.common.protocol.grpc.cloudevents.CloudEvent getDefaultInstanceForType() {
    return DEFAULT_INSTANCE;
  }
